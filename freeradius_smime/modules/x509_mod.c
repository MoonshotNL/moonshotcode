/*
This module is used to convert public and private certificates into x509 format.
It obtains the certificates from the location defined in freeradius.conf or radiusd.conf, of the certificate to load in BIO.
For private certificates, the password location is also read from those files.
*/
